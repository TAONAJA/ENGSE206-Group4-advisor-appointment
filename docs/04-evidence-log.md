...
|---|---|---|---|---|---|---|
| **RC-01** | ระบบต้องแสดงเวลาว่างของอาจารย์ และให้นักศึกษากดนัดหมายได้ | เพื่อให้เห็นเวลาที่แน่นอน จะได้ไม่ไปเสียเที่ยว | E-01, E-02 | Candidate | High | ตรวจสอบหน้าตารางเวลาบนเว็บ |
| **RC-02** | ระบบต้องมีฟอร์มให้กรอกเรื่องที่ขอเข้าพบ และแนบไฟล์เอกสารได้ | เพื่อให้อาจารย์รู้เรื่องก่อนวันนัด | E-03 | Candidate | High | ตรวจสอบฟอร์มนัดหมาย |
| **RC-03** | ระบบต้องให้อาจารย์กด ยอมรับ ปฏิเสธ หรือขอเปลี่ยนเวลานัดได้ | เพื่อให้อาจารย์จัดการคิวนัดได้สะดวก | E-04 | Candidate | High | ตรวจสอบหน้าจัดการคำขอของอาจารย์ |
| **RC-04** | ระบบต้องบังคับให้นัดหมายล่วงหน้าอย่างน้อย 1 วัน | ป้องกันการนัดกะทันหันจนอาจารย์เตรียมตัวไม่ทัน | E-01, E-03 | Candidate | Medium | ทดสอบการเลือกวันในฟอร์ม |
| **RC-05** | ระบบต้องมีให้เลือกนัดแบบเจอตัว (On-site) หรือออนไลน์ | เพิ่มความสะดวกกรณีอยู่ต่างสถานที่ | E-03, E-04 | Candidate | Medium | ตรวจสอบตัวเลือกในฟอร์ม |
| **RC-06** | ระบบต้องส่งแจ้งเตือนผ่านเว็บและอีเมลเมื่อสถานะการนัดเปลี่ยน | เพื่อให้รู้ทันทีเมื่ออาจารย์ตอบรับหรือปฏิเสธ | E-05, E-06 | Candidate | High | ทดสอบระบบส่งอีเมล |
| **RC-07** | ระบบต้องบันทึกประวัติและสรุปผลการเข้าพบได้ | ไว้ดูย้อนหลังว่าเคยคุยเรื่องอะไรกันไปบ้าง | E-07, E-08 | Candidate | Medium | ตรวจสอบฟอร์มบันทึกหลังเข้าพบ |
| **RC-08** | ระบบต้องแสดงสรุปสถิติการเข้าพบและการยกเลิกนัดให้ภาควิชาดูได้ | เพื่อให้ภาควิชาเห็นภาพรวมการนัดหมาย | E-07, E-08 | Candidate | Medium | ตรวจสอบหน้าสรุปสถิติ |
