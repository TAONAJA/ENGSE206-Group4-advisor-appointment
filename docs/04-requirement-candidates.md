...
|---|---|---|---|---|---|---|
| **RC-01** | ระบบต้องแสดงช่วงเวลาว่าง (Office Hours) ของอาจารย์ที่ปรึกษา เพื่อให้นักศึกษาสามารถเลือกวันและเวลาสำหรับการนัดหมายได้ | Functional | E-01, E-02 | Candidate | High | ยืนยันแหล่งข้อมูลตารางเวลาและทดสอบการแสดงช่วงเวลาว่าง |
| **RC-02** | ระบบต้องให้นักศึกษาสร้างคำขอนัดหมาย โดยระบุหัวข้อ วัตถุประสงค์ และแนบเอกสารประกอบได้ เพื่อให้อาจารย์มีข้อมูลเพียงพอสำหรับการพิจารณา | Functional | E-03 | Candidate | High | ยืนยันข้อมูลที่จำเป็น (Required Fields) และประเภทไฟล์ที่รองรับ |
| **RC-03** | ระบบต้องให้อาจารย์สามารถอนุมัติ ปฏิเสธ หรือเสนอวันและเวลานัดหมายใหม่ได้ เมื่อไม่สามารถเข้าพบตามเวลาที่ร้องขอ | Functional / Business Rule | E-04 | Candidate | High | ยืนยันเงื่อนไขและขั้นตอนการเสนอเปลี่ยนเวลานัด |
| **RC-04** | ระบบต้องแจ้งให้ผู้เกี่ยวข้องทราบเมื่อมีคำขอนัดหมายใหม่ หรือเมื่อสถานะของคำขอนัดหมายมีการเปลี่ยนแปลง | Functional / Usability | E-05, E-06 | Candidate | High | ยืนยันเหตุการณ์ที่ต้องแจ้งเตือน ช่องทางการแจ้งเตือน และเวลาที่เหมาะสม |
| **RC-05** | ระบบต้องกำหนดเงื่อนไขการยกเลิกหรือเลื่อนนัดหมายให้เป็นไปตามนโยบายของหน่วยงาน เพื่อสนับสนุนการบริหารตารางเวลาของอาจารย์ | Functional / Business Rule | E-03, E-04, C-01 | Candidate | Medium | ยืนยันนโยบายการยกเลิกหรือเลื่อนนัดกับผู้มีอำนาจ |
| **RC-06** | ระบบต้องรองรับการนัดหมายทั้งแบบพบหน้า (On-site) และแบบออนไลน์ โดยให้อาจารย์กำหนดรูปแบบการเข้าพบได้ | Functional | E-03, E-04, C-04 | Candidate | Medium | ยืนยันประเภทการนัดหมายและข้อมูลเพิ่มเติมที่ต้องระบุ |
| **RC-07** | ระบบต้องกำหนดสิทธิ์การเข้าถึงข้อมูลการนัดหมายตามบทบาทของผู้ใช้งาน เพื่อให้เฉพาะผู้ที่ได้รับอนุญาตสามารถเข้าถึงข้อมูลได้ | NFR – Security / Access Control | E-08 | Candidate | High | จัดทำ Role & Permission Matrix และตรวจสอบสิทธิ์ของแต่ละบทบาท |
| **RC-08** | ระบบต้องสนับสนุนการบันทึกประวัติการนัดหมายและการสรุปรายงานข้อมูลการเข้าพบ เพื่อสนับสนุนการติดตามและวิเคราะห์ข้อมูลของภาควิชา | Functional / Reporting | E-08 | Candidate | Medium | ยืนยันรูปแบบรายงาน ตัวชี้วัด และผู้ที่มีสิทธิ์เข้าถึงข้อมูล |
