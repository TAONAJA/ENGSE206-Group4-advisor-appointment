...
|---|---|---|---|---|---|
| **UC-01** | ตรวจสอบตารางเวลาว่างของอาจารย์ | นักศึกษา | ทราบช่วงเวลา Office Hours ที่แน่นอนของอาจารย์ | FR-01, NFR-03 | `../diagrams/use-case/uc01-view-availability.png` |
| **UC-02** | ส่งคำขอนัดหมายเข้าพบ| นักศึกษา | จองช่วงเวลาพร้อมระบุเหตุผลและเอกสารประกอบ | FR-02, FR-05 | `../diagrams/use-case/uc02-create-request.png` |
| **UC-03** | พิจารณาคำขอนัดหมาย | อาจารย์ที่ปรึกษา | อนุมัติ ปฏิเสธ หรือขอเสนอเลื่อนเวลานัดหมาย | FR-03, FR-05 | `../diagrams/use-case/uc03-manage-request.png` |
| **UC-04** | ยกเลิกนัดหมาย | นักศึกษา / อาจารย์ | ขอยกเลิกการนัดหมายตามเงื่อนไขเวลาที่กำหนด | BR-ADV-01, NFR-04 | `../diagrams/use-case/uc04-cancel-appointment.png` |
| **UC-05** | ส่งการแจ้งเตือน | ระบบ | แจ้งผู้ใช้เมื่อมีคำขอใหม่หรือสถานะคำขอเปลี่ยนแปลง | FR-04 | `../diagrams/use-case/uc05-send-notification.png` |
| **UC-06** | บันทึกสรุปผลการเข้าพบ  | อาจารย์| บันทึกประวัติและข้อสรุปการให้คำปรึกษา | FR-06 | `../diagrams/use-case/uc06-record-notes.png` |
